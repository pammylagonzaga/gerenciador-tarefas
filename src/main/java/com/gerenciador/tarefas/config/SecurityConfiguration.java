...
import com.gerenciador.tarefas.filter.AuthenticacaoFiltro;
...
public class SecurityConfiguration{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws  Exception{
        ...
        http.csrf(crs -> crs.disable())
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/login").permitAll()
                                ...
                                .requestMatchers(HttpMethod.POST, "usuarios").hasAuthority(PermissaoEnum.USUARIO.toString())
                                .anyRequest()
                                .authenticated());
        ...
        http.addFilterBefore(new AuthenticacaoFiltro(), UsernamePasswordAuthenticationFilter.class);
